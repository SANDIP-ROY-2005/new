...
const mainGrid= document.querySelector(".favorites .movie-grid");
 const genre = document.querySelectorAll(".category");
 // top rated or trending  = 'https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&sort_by=vote_average.desc&without_genres=99,10755&vote_count.gte=200.desc&api_key=48a5eed5c9e9c34a29e8ed115e1bd076' ;
   
//  popular = 'https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc&api_key=48a5eed5c9e9c34a29e8ed115e1bd076 ';
...
let data = await response.json();
 console.log(data.results);
return data.results;
//   if(datona.respse === 'True'){
//      console.log(data.results);
//   return data.results;
//  }
 
//  else{
//     URL= 'https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc&api_key=48a5eed5c9e9c34a29e8ed115e1bd076 ';
